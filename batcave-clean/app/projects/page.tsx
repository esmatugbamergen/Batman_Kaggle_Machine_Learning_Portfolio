...
// Panel butonları için görselle uyumlu stil - CSSProperties tipi eklendi
const masterButtonStyle: CSSProperties = {
  ...
  cursor: 'pointer',
  textAlign: 'center' as const, // TypeScript fix: 'as const' veya tip ataması
  height: '100%',
  width: '100%'
};
      ...
      <main style={{ maxWidth: '1700px', margin: '0 auto', padding: '0 20px' }}>
       {myProjects.map((p, i) => (
          <div key={i} style={{ display: 'flex', flexDirection: i % 2 === 0 ? 'row' : 'row-reverse', alignItems: 'center', gap: '5vw', marginBottom: '160px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <div style={{ flex: '1', textAlign: (i % 2 === 0 ? 'left' : 'right') as CSSProperties['textAlign'], minWidth: '320px', padding: '20px' }}>
